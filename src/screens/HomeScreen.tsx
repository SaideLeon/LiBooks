    ...
    <div className="w-full">
      ...
      {isLoading ? <div className="flex justify-center p-8"><Spinner /></div> : <>
        ...
        <section className="w-full mt-6">
            <h2 className="px-4 lg:px-8 pb-3 pt-5 text-[22px] font-bold leading-tight tracking-[-0.015em] text-text-light dark:text-text-dark">Descubra Novos Livros</h2>
                <div className="flex overflow-x-auto [-ms-scrollbar-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                    <div className="flex flex-none items-stretch gap-4 px-4 lg:px-8 py-2">
                        {allBooks.map(book => (
                            <BookCarouselItem 
