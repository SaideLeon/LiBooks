...
const ThemeSwitcher: React.FC = () => {
    ...
    return (
        <div className="flex items-center rounded-lg bg-background-light dark:bg-zinc-900 p-1 ring-1 ring-inset ring-zinc-200 dark:ring-zinc-700">
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark min-h-full">
            <header className="sticky top-0 z-10 flex h-16 items-center border-b border-card-light/50 bg-background-light/80 px-4 backdrop-blur-sm dark:border-card-dark/50 dark:bg-background-dark/80">
                <h1 className="w-full text-center text-xl font-bold text-text-light dark:text-text-dark lg:text-left">Ajustes</h1>
            </header>
